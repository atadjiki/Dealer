...
namespace TGS {
    ...
    public partial class TerrainGridSystem : MonoBehaviour {
        ...
        static void InitDomain() {
            TerrainGridSystem[] grids = FindObjectsOfType<TerrainGridSystem>(true);
        ...
        void DisplayCellInfo() {
            ...
            if (cellDebugInfo == CellDebugInfo.Nothing && _numTerritories > 0 && _territoriesInitialCellMethod == TerritoryInitialCellMethod.UserDefined) {
        ...
        void UpdateMaterialDepthOffset() {
            ...
            if (cells != null) {
                ...
                for (int c = 0; c < cellsCount; c++) {
                    Cell cell = cells[c];
                    if (cell != null && cell.region != null && cell.region.renderer != null) {
        ...
        GameObject GenerateRegionSurfaceHighlightSimpleShape(Material material) {
                ...
                if (_gridTopology != GridTopology.Irregular && _terrainWrapper == null) {
                    ...
                    if (cell.region.points.Count == expectedPointCount) { // merged cells can't use this optimization
                        if (_highlightedRefSurface == null) {
                            _highlightedRefSurface = GenerateRegionSurfaceHighlightSimpleShape(hudMatCell);
                        }
                        if (_highlightedRefSurface != null) {
