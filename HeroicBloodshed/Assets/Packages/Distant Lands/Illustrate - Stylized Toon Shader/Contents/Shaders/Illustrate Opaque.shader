		...
		Pass
		{
			...
			float3 ASEIndirectDiffuse( float2 uvStaticLightmap, float3 normalWS )
			{
				...
				return SampleSH(normalWS);
					...
					float2 voronoihash288_g1194( float2 p )
					{
						p = p - 1 * floor( p / 1 );
					...
					float voronoi288_g1194( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
					{
						float2 n = floor( v );
						float2 f = frac( v );
						float F1 = 8.0;
						...
						for ( int j = -1; j <= 1; j++ )
						{
							for ( int i = -1; i <= 1; i++ )
						 	{
						 		float2 g = float2( i, j );
						 		float2 o = voronoihash288_g1194( n + g );
			...
			half4 CalculateShadowMask1_g1197( half2 LightmapUV )
			{
				 ...
				 ) : SV_Target
			{
				...
				float4 temp_output_14_0_g1159 = ( _MainColor * tex2D( _Texture, uv_Texture ) );
				float temp_output_21_0_g1160 = _GradientSource;
				float3 worldToObj9_g1159 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float3 AdjustedPosition10_g1159 = ( ( _Space == 0.0 ? WorldPosition : worldToObj9_g1159 ) - _GradientPositionalOffset );
				float3 temp_output_23_0_g1160 = AdjustedPosition10_g1159;
				float temp_output_1_0_g1160 = distance( ( -_GradientOffset + temp_output_23_0_g1160 ) , float3( 0,0,0 ) );
				float3 temp_output_22_0_g1160 = _GradientChannelMask;
				float temp_output_31_0_g1160 = length( ( ( -_GradientOffset + temp_output_23_0_g1160 ) * temp_output_22_0_g1160 ) );
				float temp_output_30_0_g1160 = length( ( float4( temp_output_22_0_g1160 , 0.0 ) * IN.ase_color ) );
				float Distance15_g1159 = saturate( ( ( ( temp_output_21_0_g1160 == 3.0 ? 1.0 : 0.0 ) + ( temp_output_21_0_g1160 == 0.0 ? temp_output_1_0_g1160 : 0.0 ) + ( temp_output_21_0_g1160 == 1.0 ? temp_output_31_0_g1160 : 0.0 ) + ( temp_output_21_0_g1160 == 2.0 ? temp_output_30_0_g1160 : 0.0 ) ) * _GradientSensitivity ) );
				float4 lerpResult32_g1159 = lerp( _NearColor , _FarColor , Distance15_g1159);
				float4 AdjustedGradient34_g1159 = lerpResult32_g1159;
				float3 lerpResult28_g1159 = lerp( (temp_output_14_0_g1159).rgb , (AdjustedGradient34_g1159).rgb , (AdjustedGradient34_g1159).a);
				float4 appendResult57_g1159 = (float4(lerpResult28_g1159 , (temp_output_14_0_g1159).a));
				float4 temp_output_1_0_g1155 = ( _UseGradientShading == 1.0 ? appendResult57_g1159 : temp_output_14_0_g1159 );
				float3 hsvTorgb3_g1155 = RGBToHSV( temp_output_1_0_g1155.xyz );
				float temp_output_1_0_g1158 = hsvTorgb3_g1155.x;
				float temp_output_2_0_g1158 = abs( _HueShift );
				float temp_output_7_0_g1158 = ( temp_output_1_0_g1158 - 0.5 );
				float temp_output_1_0_g1156 = hsvTorgb3_g1155.y;
				float temp_output_2_0_g1156 = _SaturationShift;
				float temp_output_7_0_g1156 = ( temp_output_1_0_g1156 - 0.5 );
				float temp_output_1_0_g1157 = hsvTorgb3_g1155.z;
				float temp_output_2_0_g1157 = _ValueShift;
				float temp_output_7_0_g1157 = ( temp_output_1_0_g1157 - 0.5 );
				float3 hsvTorgb12_g1155 = HSVToRGB( float3(saturate( ( _ClampAdjustments == 0.0 ? ( temp_output_1_0_g1158 + temp_output_2_0_g1158 ) : ( temp_output_1_0_g1158 + ( ( ( 0.25 - ( temp_output_7_0_g1158 * temp_output_7_0_g1158 ) ) * 4.0 ) * temp_output_2_0_g1158 ) ) ) ),saturate( ( _ClampAdjustments == 0.0 ? ( temp_output_1_0_g1156 + temp_output_2_0_g1156 ) : ( temp_output_1_0_g1156 + ( ( ( 0.25 - ( temp_output_7_0_g1156 * temp_output_7_0_g1156 ) ) * 4.0 ) * temp_output_2_0_g1156 ) ) ) ),saturate( ( _ClampAdjustments == 0.0 ? ( temp_output_1_0_g1157 + temp_output_2_0_g1157 ) : ( temp_output_1_0_g1157 + ( ( ( 0.25 - ( temp_output_7_0_g1157 * temp_output_7_0_g1157 ) ) * 4.0 ) * temp_output_2_0_g1157 ) ) ) )) );
				float4 appendResult4_g1155 = (float4(saturate( hsvTorgb12_g1155 ) , (temp_output_1_0_g1155).w));
				float4 temp_output_1_0_g1161 = ( _UseColorAdjustments == 1.0 ? appendResult4_g1155 : temp_output_1_0_g1155 );
				float3 hsvTorgb3_g1161 = RGBToHSV( temp_output_1_0_g1161.xyz );
				float3 objToWorld17_g1164 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1164 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1164 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1164).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord4.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1164 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1164 = snoise( Source25_g1164*_VariationScale );
				float3 objToWorld17_g1162 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1162 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1162 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1162).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord4.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1162 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1162 = snoise( Source25_g1162*_VariationScale );
				float3 objToWorld17_g1163 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1163 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1163 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1163).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord4.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1163 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1163 = snoise( Source25_g1163*_VariationScale );
				float3 hsvTorgb12_g1161 = HSVToRGB( float3(saturate( ( hsvTorgb3_g1161.x + ( simplePerlin2D4_g1164 * _UseHSVVariation * _HueVariation ) ) ),saturate( ( hsvTorgb3_g1161.y + ( simplePerlin2D4_g1162 * _UseHSVVariation * _SaturationVariation ) ) ),saturate( ( hsvTorgb3_g1161.z + ( simplePerlin2D4_g1163 * _UseHSVVariation * _ValueVariation ) ) )) );
				float4 appendResult4_g1161 = (float4(saturate( hsvTorgb12_g1161 ) , (temp_output_1_0_g1161).w));
				float4 temp_output_15_0_g1180 = appendResult4_g1161;
				...
				float lightMode277_g1194 = _LightingMode;
				float multiplyByLightColor201_g1194 = _MultiplyByLightColor;
				float3 ase_worldNormal = IN.ase_texcoord6.xyz;
				float3 bakedGI361_g1194 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, ase_worldNormal);
				Light ase_mainLight = GetMainLight( ShadowCoords );
				MixRealtimeAndBakedGI(ase_mainLight, ase_worldNormal, bakedGI361_g1194, half4(0,0,0,0));
				float useHalftone324_g1194 = _UseHalftone;
				float temp_output_8_0_g1194 = ( _LightRamp * 0.5 );
				...
				float3 temp_output_191_0_g1194 = temp_output_887_0;
				float3 normals338_g1194 = temp_output_191_0_g1194;
				float dotResult1_g1194 = dot( _MainLightPosition.xyz , normals338_g1194 );
				float ase_lightAtten = 0;
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float LightAttenuation100_g1194 = ( _UseShadows == 1.0 ? ase_lightAtten : 1.0 );
				float temp_output_12_0_g1194 = ( (dotResult1_g1194*0.5 + 0.5) * LightAttenuation100_g1194 );
				float smoothstepResult10_g1194 = smoothstep( ( _LightRampOffset - temp_output_8_0_g1194 ) , ( _LightRampOffset + temp_output_8_0_g1194 ) , ( _PosterizeLight == 1.0 ? ( round( ( temp_output_12_0_g1194 * _LightSteps ) ) / _LightSteps ) : temp_output_12_0_g1194 ));
				float preLightRatio308_g1194 = saturate( smoothstepResult10_g1194 );
				float time288_g1194 = 0.0;
				float2 voronoiSmoothId288_g1194 = 0;
				float4 screenPos = IN.ase_texcoord9;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 coords288_g1194 = (( ase_screenPosNorm * _ScreenParams )*_HalftoneScale + 0.0).xy * 0.02;
				float2 id288_g1194 = 0;
				float2 uv288_g1194 = 0;
				float voroi288_g1194 = voronoi288_g1194( coords288_g1194, time288_g1194, id288_g1194, uv288_g1194, 0, voronoiSmoothId288_g1194 );
				float halftone295_g1194 = (0.0 + (( voroi288_g1194 - _HalftoneOffset ) - 0.0) * (( _HalftoneMultiplier * 2.0 ) - 0.0) / (1.0 - 0.0));
				float lightRatio37_g1194 = ( useHalftone324_g1194 == 0.0 ? preLightRatio308_g1194 : ( ( preLightRatio308_g1194 - halftone295_g1194 ) > 0.5 ? 1.0 : 0.0 ) );
				float4 lerpResult22_g1194 = lerp( ( multiplyByLightColor201_g1194 == 1.0 ? ( float4( bakedGI361_g1194 , 0.0 ) * _ShadowColor ) : _ShadowColor ) , ( multiplyByLightColor201_g1194 == 1.0 ? ( _MainLightColor * _LightColor ) : _LightColor ) , lightRatio37_g1194);
				float4 FinalLighting134_g1194 = lerpResult22_g1194;
				float3 worldPosValue102_g1196 = WorldPosition;
				float3 WorldPosition118_g1196 = worldPosValue102_g1196;
				float2 ScreenUV105_g1196 = (ase_screenPosNorm).xy;
				float2 ScreenUV118_g1196 = ScreenUV105_g1196;
				half2 LightmapUV1_g1197 = (IN.ase_texcoord3.zw*(unity_LightmapST).xy + (unity_LightmapST).zw);
				half4 localCalculateShadowMask1_g1197 = CalculateShadowMask1_g1197( LightmapUV1_g1197 );
				float4 shadowMaskValue113_g1196 = localCalculateShadowMask1_g1197;
				float4 ShadowMask118_g1196 = shadowMaskValue113_g1196;
				float temp_output_123_0_g1196 = _AdditionalLightRamp;
				float Ramp118_g1196 = temp_output_123_0_g1196;
				float3 localAdditionalLightsFlatMask14x118_g1196 = AdditionalLightsFlatMask14x( WorldPosition118_g1196 , ScreenUV118_g1196 , ShadowMask118_g1196 , Ramp118_g1196 );
				float3 normalizeResult129_g1196 = normalize( localAdditionalLightsFlatMask14x118_g1196 );
				float3 FlatResult131_g1196 = ( length( localAdditionalLightsFlatMask14x118_g1196 ) > 1.0 ? normalizeResult129_g1196 : localAdditionalLightsFlatMask14x118_g1196 );
				float3 posterizedLight236_g1194 = FlatResult131_g1196;
				float4 appendResult281_g1194 = (float4((( lightMode277_g1194 == 1.0 ? ( FinalLighting134_g1194 + float4( posterizedLight236_g1194 , 0.0 ) ) : float4( 1,1,1,1 ) )).rgb , 1.0));
				float4 SpecularColor103_g1194 = _SpecularColor;
				float temp_output_167_0_g1194 = ( ( _SpecularRampOffset + 1.0 ) / 2.0 );
				float temp_output_111_0_g1194 = ( _SpecularRamp * 2 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult4_g1195 = normalize( ( ase_worldViewDir + _MainLightPosition.xyz ) );
				float3 ModifiedNormal155_g1194 = ( _UseModifiedNormals == 0.0 ? ase_worldNormal : temp_output_191_0_g1194 );
				float3 normalizeResult84_g1194 = normalize( ModifiedNormal155_g1194 );
				float dotResult80_g1194 = dot( normalizeResult4_g1195 , normalizeResult84_g1194 );
				float smoothstepResult113_g1194 = smoothstep( ( temp_output_167_0_g1194 - temp_output_111_0_g1194 ) , ( temp_output_167_0_g1194 + temp_output_111_0_g1194 ) , max( dotResult80_g1194 , 0.0 ));
				float Specular102_g1194 = ( _SpecularColor.a * smoothstepResult113_g1194 );
				float4 FinalSpecular133_g1194 = ( ( multiplyByLightColor201_g1194 == 1.0 ? _MainLightColor : float4( 1,1,1,0 ) ) * SpecularColor103_g1194 * ( Specular102_g1194 * lightRatio37_g1194 ) * _UseSpecular );
				float4 RimColor119_g1194 = _RimLightColor;
				float temp_output_127_0_g1194 = ( _RimRamp * 0.5 );
				float dotResult124_g1194 = dot( ModifiedNormal155_g1194 , ase_worldViewDir );
				float smoothstepResult129_g1194 = smoothstep( ( _RimLightRampOffset - temp_output_127_0_g1194 ) , ( _RimLightRampOffset + temp_output_127_0_g1194 ) , max( ( 1.0 - dotResult124_g1194 ) , 0.0 ));
				float Rim117_g1194 = ( _RimLightColor.a * smoothstepResult129_g1194 );
				float lerpResult148_g1194 = lerp( _RimLightShadowIntensity , _RimLightLitIntensity , lightRatio37_g1194);
				float temp_output_142_0_g1194 = ( Rim117_g1194 * lerpResult148_g1194 );
				float4 FinalRim145_g1194 = ( RimColor119_g1194 * ( useHalftone324_g1194 == 0.0 ? temp_output_142_0_g1194 : ( ( temp_output_142_0_g1194 - halftone295_g1194 ) > 0.5 ? 1.0 : 0.0 ) ) * _UseRimLighting );
				float temp_output_898_32 = ( lightMode277_g1194 == 1.0 ? saturate( ( length( posterizedLight236_g1194 ) + lightRatio37_g1194 ) ) : 1.0 );
				...
				float lerpResult20_g1166 = lerp( _EmissionShadowRatio , _EmissionLightRatio , temp_output_898_32);
				float2 temp_cast_11 = (_EmissionEffectScale).xx;
				float2 texCoord5_g1166 = IN.ase_texcoord3.xy * temp_cast_11 + float2( 0,0 );
				...
				float lerpResult37_g1153 = lerp( ( 1.0 - _NoiseAmountShadow ) , ( 1.0 - _NoiseAmountLight ) , temp_output_898_32);
				...
				float3 Color = ( ( ( ( _PosterizeColors == 1.0 ? appendResult8_g1180 : temp_output_15_0_g1180 ) * appendResult281_g1194 ) + float4( (( lightMode277_g1194 == 1.0 ? ( FinalSpecular133_g1194 + FinalRim145_g1194 ) : float4( 0,0,0,0 ) )).rgb , 0.0 ) + ( _UseGlint * ( _MultiplyByLightRatio == 1.0 ? ( temp_output_898_32 * Glint23_g1188 ) : Glint23_g1188 ) ) + ( _UseEmission == 0.0 ? float4( 0,0,0,0 ) : ( lerpResult20_g1166 * _EmissionColor * ( _ScrollEmission == 0.0 ? DefaultEmission31_g1166 : ScrolledEmission25_g1166 ) ) ) ) * ( _UseScreenNoise == 1.0 ? ScreenspaceNoise23_g1153 : 1.0 ) ).xyz;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.RangedFloatNode;664;-959,-1680;Inherit;False;InstancedProperty;_CullMode;Cull Mode;48;1;[Enum];Create;True;0;3;Two Sided;0;Cull Front;1;Cull Back;2;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;299;288,-1408;Inherit;False;4;4;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;755;-48,-1120;Inherit;False;Screenspace Noise;101;;1153;5e9a786262a092f488efb11845fd6e36;0;1;40;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;338;32,-1488;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;115;512,-1408;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;468;1008,-1408;Float;False;True;-1;2;IllustrateEditor;0;13;Distant Lands/Illustrate/Opaque;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;638201235824325068;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;638201042370953364;0;10;False;True;True;True;False;False;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.FunctionNode;882;-928,-1488;Inherit;False;Texture Block;0;;1154;4918127142e778a4a9e764dde15ce8c2;0;0;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;883;-560,-1488;Inherit;False;Adjust Color;58;;1155;3c1e998ab8b1a3843a23a5fe34c8bbc3;0;1;1;FLOAT4;1,1,1,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;884;-752,-1488;Inherit;False;Gradient;38;;1159;fda248e61446ae246bc4b3d542b7072c;0;1;14;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;880;-368,-1488;Inherit;False;HSV Variation;3;;1161;ca5d2276ff902f6439e6cdd3685031b4;0;1;1;FLOAT4;1,1,1,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;886;-48,-1216;Inherit;False;Emission;90;;1166;8bfb35ab5d7b99742a36e8551a29259e;0;1;21;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;887;-656,-1392;Inherit;False;Custom Normals;49;;1167;b77cb78b6acab4a48b84461b1772ff9e;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;888;512,-1216;Inherit;False;Swirling Noise;132;;1168;9a3d91a82277abc46966b9af21c17a04;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;889;512,-1296;Inherit;False;Fluttering Noise;121;;1171;b38a8c9eef50ed746b29c9f61485ae0d;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;890;512,-1136;Inherit;False;Swaying Noise;110;;1174;883d0da31ba823541b98d418e4516d72;0;0;1;FLOAT3;16
Node;AmplifyShaderEditor.FunctionNode;891;512,-1056;Inherit;False;Waving Noise;19;;1177;cadadbf7b0bd28f4e978f83999c65368;0;0;1;FLOAT3;16
Node;AmplifyShaderEditor.FunctionNode;892;-176,-1488;Inherit;False;Posterize Texture;55;;1180;2cee7f234007b2a458c94bbdaf6405dc;0;1;15;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;896;-48,-1312;Inherit;False;Glint;32;;1188;b3529c5fbdfb23848a365c71df3e9f0e;0;1;4;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;898;-398,-1390;Inherit;False;Lighting;64;;1194;686dba7250013234d892aef0d32c104d;0;1;191;FLOAT3;0,0,0;False;3;FLOAT4;0;FLOAT3;205;FLOAT;32
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;901;1008,-1358;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ScenePickingPass;0;7;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;902;1008,-1358;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthNormals;0;8;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormalsOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;903;1008,-1358;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthNormalsOnly;0;9;DepthNormalsOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormalsOnly;False;True;9;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;switch;0;;0;0;Standard;0;False;0
WireConnection;299;0;338;0
WireConnection;299;1;898;205
WireConnection;299;2;896;0
WireConnection;299;3;886;0
WireConnection;755;40;898;32
WireConnection;490;0;887;0
WireConnection;338;0;892;0
WireConnection;338;1;898;0
...
WireConnection;883;1;884;0
WireConnection;884;14;882;0
WireConnection;880;1;883;0
WireConnection;886;21;898;32
WireConnection;892;15;880;0
WireConnection;896;4;898;32
WireConnection;898;191;887;0
ASEEND*/
//CHKSM=1C9FC3D82BA8EB71835A163A6340EE769C808FFA