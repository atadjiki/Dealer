	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 hsvTorgb3_g1161 = RGBToHSV( temp_output_1_0_g1161.xyz );
				float3 objToWorld17_g1164 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1164 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1164 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1164).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord3.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1164 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1164 = snoise( Source25_g1164*_VariationScale );
				float3 objToWorld17_g1162 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1162 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1162 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1162).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord3.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1162 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1162 = snoise( Source25_g1162*_VariationScale );
				float3 objToWorld17_g1163 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1163 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1163 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1163).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord3.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1163 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1163 = snoise( Source25_g1163*_VariationScale );
				float3 hsvTorgb12_g1161 = HSVToRGB( float3(saturate( ( hsvTorgb3_g1161.x + ( simplePerlin2D4_g1164 * _UseHSVVariation * _HueVariation ) ) ),saturate( ( hsvTorgb3_g1161.y + ( simplePerlin2D4_g1162 * _UseHSVVariation * _SaturationVariation ) ) ),saturate( ( hsvTorgb3_g1161.z + ( simplePerlin2D4_g1163 * _UseHSVVariation * _ValueVariation ) ) )) );
				float4 appendResult4_g1161 = (float4(saturate( hsvTorgb12_g1161 ) , (temp_output_1_0_g1161).w));
				float4 temp_output_15_0_g1180 = appendResult4_g1161;
				...
				float lerpResult20_g1166 = lerp( _EmissionShadowRatio , _EmissionLightRatio , temp_output_893_32);
				float2 temp_cast_11 = (_EmissionEffectScale).xx;
				float2 texCoord5_g1166 = IN.ase_texcoord2.xy * temp_cast_11 + float2( 0,0 );
				float4 UVs26_g1166 = ( _EmissionUVSource == 0.0 ? float4( texCoord5_g1166, 0.0 , 0.0 ) : (ase_screenPosNorm*_EmissionEffectScale + 0.0) );
				float4 DefaultEmission31_g1166 = tex2D( _EmissionTexture, UVs26_g1166.xy );
				float4 ScrolledEmission25_g1166 = max( tex2D( _EmissionTexture, (UVs26_g1166*1.0 + float4( ( _EmissionScrolling1 * sin( _TimeParameters.x * 0.25 ) ), 0.0 , 0.0 )).xy ) , tex2D( _EmissionTexture, (UVs26_g1166*0.9 + float4( ( sin( _TimeParameters.x * 0.5 ) * _EmissionScrolling2 ), 0.0 , 0.0 )).xy ) );
				float lerpResult37_g1153 = lerp( ( 1.0 - _NoiseAmountShadow ) , ( 1.0 - _NoiseAmountLight ) , temp_output_893_32);
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;468;1008,-1408;Float;False;True;-1;2;IllustrateEditor;0;13;Distant Lands/Illustrate/Transparent;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638208097954055528;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;638201042370953364;0;10;False;True;True;True;False;False;True;True;True;False;False;;False;0
...
Node;AmplifyShaderEditor.FunctionNode;885;-48,-1312;Inherit;False;Glint;32;;1165;b3529c5fbdfb23848a365c71df3e9f0e;0;1;4;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;893;-398,-1390;Inherit;False;Lighting;64;;1181;686dba7250013234d892aef0d32c104d;0;1;191;FLOAT3;0,0,0;False;3;FLOAT4;0;FLOAT3;205;FLOAT;32
Node;AmplifyShaderEditor.ComponentMaskNode;894;733.773,-1338.79;Inherit;False;False;False;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;895;1008,-1358;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=A8B03AAB94BCC9B2D881C1142AF78E678FE614CF