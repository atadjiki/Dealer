	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 temp_output_14_0_g1186 = ( _MainColor * tex2D( _Texture, uv_Texture ) );
				float temp_output_21_0_g1187 = _GradientSource;
				float3 worldToObj9_g1186 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float3 AdjustedPosition10_g1186 = ( ( _Space == 0.0 ? WorldPosition : worldToObj9_g1186 ) - _GradientPositionalOffset );
				float3 temp_output_23_0_g1187 = AdjustedPosition10_g1186;
				float temp_output_1_0_g1187 = distance( ( -_GradientOffset + temp_output_23_0_g1187 ) , float3( 0,0,0 ) );
				float3 temp_output_22_0_g1187 = _GradientChannelMask;
				float temp_output_31_0_g1187 = length( ( ( -_GradientOffset + temp_output_23_0_g1187 ) * temp_output_22_0_g1187 ) );
				float temp_output_30_0_g1187 = length( ( float4( temp_output_22_0_g1187 , 0.0 ) * IN.ase_color ) );
				float Distance15_g1186 = saturate( ( ( ( temp_output_21_0_g1187 == 3.0 ? 1.0 : 0.0 ) + ( temp_output_21_0_g1187 == 0.0 ? temp_output_1_0_g1187 : 0.0 ) + ( temp_output_21_0_g1187 == 1.0 ? temp_output_31_0_g1187 : 0.0 ) + ( temp_output_21_0_g1187 == 2.0 ? temp_output_30_0_g1187 : 0.0 ) ) * _GradientSensitivity ) );
				float4 lerpResult32_g1186 = lerp( _NearColor , _FarColor , Distance15_g1186);
				float4 AdjustedGradient34_g1186 = lerpResult32_g1186;
				float3 lerpResult28_g1186 = lerp( (temp_output_14_0_g1186).rgb , (AdjustedGradient34_g1186).rgb , (AdjustedGradient34_g1186).a);
				float4 appendResult57_g1186 = (float4(lerpResult28_g1186 , (temp_output_14_0_g1186).a));
				float4 temp_output_1_0_g1181 = ( _UseGradientShading == 1.0 ? appendResult57_g1186 : temp_output_14_0_g1186 );
				float3 hsvTorgb3_g1181 = RGBToHSV( temp_output_1_0_g1181.xyz );
				float temp_output_1_0_g1184 = hsvTorgb3_g1181.x;
				float temp_output_2_0_g1184 = abs( _HueShift );
				float temp_output_7_0_g1184 = ( temp_output_1_0_g1184 - 0.5 );
				float temp_output_1_0_g1182 = hsvTorgb3_g1181.y;
				float temp_output_2_0_g1182 = _SaturationShift;
				float temp_output_7_0_g1182 = ( temp_output_1_0_g1182 - 0.5 );
				float temp_output_1_0_g1183 = hsvTorgb3_g1181.z;
				float temp_output_2_0_g1183 = _ValueShift;
				float temp_output_7_0_g1183 = ( temp_output_1_0_g1183 - 0.5 );
				float3 hsvTorgb12_g1181 = HSVToRGB( float3(saturate( ( _ClampAdjustments == 0.0 ? ( temp_output_1_0_g1184 + temp_output_2_0_g1184 ) : ( temp_output_1_0_g1184 + ( ( ( 0.25 - ( temp_output_7_0_g1184 * temp_output_7_0_g1184 ) ) * 4.0 ) * temp_output_2_0_g1184 ) ) ) ),saturate( ( _ClampAdjustments == 0.0 ? ( temp_output_1_0_g1182 + temp_output_2_0_g1182 ) : ( temp_output_1_0_g1182 + ( ( ( 0.25 - ( temp_output_7_0_g1182 * temp_output_7_0_g1182 ) ) * 4.0 ) * temp_output_2_0_g1182 ) ) ) ),saturate( ( _ClampAdjustments == 0.0 ? ( temp_output_1_0_g1183 + temp_output_2_0_g1183 ) : ( temp_output_1_0_g1183 + ( ( ( 0.25 - ( temp_output_7_0_g1183 * temp_output_7_0_g1183 ) ) * 4.0 ) * temp_output_2_0_g1183 ) ) ) )) );
				float4 appendResult4_g1181 = (float4(saturate( hsvTorgb12_g1181 ) , (temp_output_1_0_g1181).w));
				float4 temp_output_1_0_g1201 = ( _UseColorAdjustments == 1.0 ? appendResult4_g1181 : temp_output_1_0_g1181 );
				float3 hsvTorgb3_g1201 = RGBToHSV( temp_output_1_0_g1201.xyz );
				float3 objToWorld17_g1204 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1204 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1204 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1204).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord4.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1204 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1204 = snoise( Source25_g1204*_VariationScale );
				float3 objToWorld17_g1202 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1202 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1202 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1202).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord4.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1202 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1202 = snoise( Source25_g1202*_VariationScale );
				float3 objToWorld17_g1203 = mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz;
				float2 texCoord23_g1203 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1203 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1203).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (IN.ase_texcoord4.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1203 : float2( 0,0 ) ) );
				float simplePerlin2D4_g1203 = snoise( Source25_g1203*_VariationScale );
				float3 hsvTorgb12_g1201 = HSVToRGB( float3(saturate( ( hsvTorgb3_g1201.x + ( simplePerlin2D4_g1204 * _UseHSVVariation * _HueVariation ) ) ),saturate( ( hsvTorgb3_g1201.y + ( simplePerlin2D4_g1202 * _UseHSVVariation * _SaturationVariation ) ) ),saturate( ( hsvTorgb3_g1201.z + ( simplePerlin2D4_g1203 * _UseHSVVariation * _ValueVariation ) ) )) );
				float4 appendResult4_g1201 = (float4(saturate( hsvTorgb12_g1201 ) , (temp_output_1_0_g1201).w));
				float4 temp_output_15_0_g1180 = appendResult4_g1201;
				...
				float2 texCoord5_g1177 = IN.ase_texcoord3.xy * temp_cast_11 + float2( 0,0 );
				...
				float3 Color = ( ( ( ( _PosterizeColors == 1.0 ? appendResult8_g1180 : temp_output_15_0_g1180 ) * appendResult281_g1196 ) + float4( (( lightMode277_g1196 == 1.0 ? ( FinalSpecular133_g1196 + FinalRim145_g1196 ) : float4( 0,0,0,0 ) )).rgb , 0.0 ) + ( _UseGlint * ( _MultiplyByLightRatio == 1.0 ? ( temp_output_923_32 * Glint23_g1175 ) : Glint23_g1175 ) ) + ( _UseEmission == 0.0 ? float4( 0,0,0,0 ) : ( lerpResult20_g1177 * _EmissionColor * ( _ScrollEmission == 0.0 ? DefaultEmission31_g1177 : ScrolledEmission25_g1177 ) ) ) ) * ( _UseScreenNoise == 1.0 ? ScreenspaceNoise23_g1178 : 1.0 ) ).xyz;
				float Alpha = 1;
				float AlphaClipThreshold = 0.5;
...
Node;AmplifyShaderEditor.RangedFloatNode;664;-959,-1680;Inherit;False;InstancedProperty;_CullMode;Cull Mode;49;1;[Enum];Create;True;0;3;Two Sided;0;Cull Front;1;Cull Back;2;0;True;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;860;-8.502625,-2737.178;Inherit;False;Fluttering Noise;125;;160;b38a8c9eef50ed746b29c9f61485ae0d;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;787;-1488,-2320;Inherit;False;Swirling Noise;136;;1163;9a3d91a82277abc46966b9af21c17a04;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;791;-1488,-2240;Inherit;False;Swaying Noise;114;;1169;883d0da31ba823541b98d418e4516d72;0;0;1;FLOAT3;16
Node;AmplifyShaderEditor.FunctionNode;793;-1488,-2160;Inherit;False;Waving Noise;19;;1172;cadadbf7b0bd28f4e978f83999c65368;0;0;1;FLOAT3;16
...
Node;AmplifyShaderEditor.SimpleAddOpNode;299;640,-1408;Inherit;False;4;4;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;636;304,-1312;Inherit;False;Glint;32;;1175;b3529c5fbdfb23848a365c71df3e9f0e;0;1;4;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;633;304,-1216;Inherit;False;Emission;94;;1177;8bfb35ab5d7b99742a36e8551a29259e;0;1;21;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;755;304,-1120;Inherit;False;Screenspace Noise;105;;1178;5e9a786262a092f488efb11845fd6e36;0;1;40;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;490;-48,-1264;Inherit;False;Normals;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;749;-304,-1392;Inherit;False;Custom Normals;50;;1179;b77cb78b6acab4a48b84461b1772ff9e;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;625;128,-1488;Inherit;False;Posterize Texture;58;;1180;2cee7f234007b2a458c94bbdaf6405dc;0;1;15;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;338;384,-1488;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;115;864,-1408;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;789;-1488,-2400;Inherit;False;Fluttering Noise;125;;1193;b38a8c9eef50ed746b29c9f61485ae0d;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;853;-328.5026,-3121.178;Inherit;False;Property;_OutlineColor;Outline Color;61;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;847;-1416.503,-2593.178;Inherit;False;Property;_UseOutlines;Use Outlines;56;1;[Toggle];Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;836;-1416.503,-2689.178;Inherit;False;Property;_NormalSurfaceOutline;Normal Surface Outline;57;1;[Toggle];Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;468;1344,-1376;Float;False;True;-1;2;IllustrateEditor;0;13;Distant Lands/Illustrate/Outline;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;0;638201235824325068;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;1;638203880493062150;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;638201042370953364;0;10;True;True;True;True;False;False;True;True;True;False;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;467;400,-2944;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;True;1;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;1;False;;True;3;False;;True;False;1;False;;1;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.RangedFloatNode;858;-315.1693,-2405.95;Inherit;False;Property;_OutlineWidth;Outline Width;48;0;Create;True;1;Outline Settings;0;0;False;0;False;0.15;0.142;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;923;-48,-1392;Inherit;False;Lighting;68;;1196;686dba7250013234d892aef0d32c104d;0;1;191;FLOAT3;0,0,0;False;3;FLOAT4;0;FLOAT3;205;FLOAT;32
...
Node;AmplifyShaderEditor.FunctionNode;648;-304,-1488;Inherit;False;Adjust Color;62;;1181;3c1e998ab8b1a3843a23a5fe34c8bbc3;0;1;1;FLOAT4;1,1,1,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;747;-672,-1488;Inherit;False;Texture Block;16;;1185;4918127142e778a4a9e764dde15ce8c2;0;0;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;782;-496,-1488;Inherit;False;Gradient;38;;1186;fda248e61446ae246bc4b3d542b7072c;0;1;14;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;929;-96,-1488;Inherit;False;HSV Variation;0;;1201;ca5d2276ff902f6439e6cdd3685031b4;0;1;1;FLOAT4;1,1,1,0;False;1;FLOAT4;0
...
WireConnection;648;1;782;0
WireConnection;782;14;747;0
WireConnection;929;1;648;0
ASEEND*/
//CHKSM=E1A750E1EF11E3760F95993CA628D5D55A711604